...
export const router = createBrowserRouter([
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'settings/subscriptions', element: <Navigate to="/admin/users/subscription-health" replace /> },
      { path: 'users/subscription-health', element: <AdminSettingsSubscriptions /> },
